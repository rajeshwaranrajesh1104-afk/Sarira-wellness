...
export function WellnessAI() {
  ...
  return (
    <section id="wellness-ai" className="bg-gradient-to-br from-[#F8F5EF] via-[#F0EDE6] to-[#E5E0D8] relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#364A22]/5 via-[#4A5F2E]/3 to-[#E38A30]/5"></div>
